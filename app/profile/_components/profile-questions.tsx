...
import { ChatIcon as ChatAltIcon } from "@icons";
...
export function ProfileQuestions({ questions, slug }: ProfileQuestionsProps) {
  ...
  return (
    <div className='pb-3 mb-8 bg-sand-9/5 rounded-none p-6 -ml-5.5 -mr-5.5 md:rounded-[30px]'>
      ...
      <div className={cn("flex flex-row flex-wrap gap-2 -ml-4 -mr-4")}>
        {questions.map((question, index) => (
          <button
            ...
            className='cursor-pointer w-fit rounded-[20px] bg-sand-11/5 px-4 py-3 text-left text-sand-12 hover:bg-sand-10/10 animate-in fade-in slide-in-from-bottom-4 transition-all duration-400 active:scale-95'
            style={{
