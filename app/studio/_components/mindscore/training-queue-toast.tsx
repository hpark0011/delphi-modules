...
function TrainingQueueToast({
  ...
  return (
    <div className='flex flex-col rounded-2xl bg-[#FCFBFA] dark:bg-[#2C2C2A] w-full md:max-w-[420px] items-start p-4 pl-3 gap-1 transition-all duration-300 ease-out shadow-[0_12px_12px_0_rgba(0,0,0,0.10),0_17.2px_17.2px_-8.6px_rgba(0,0,0,0.03),0_8.6px_8.6px_-4.3px_rgba(0,0,0,0.03),0_4.3px_4.3px_-2.15px_rgba(0,0,0,0.03),0_1.075px_1.075px_-0.538px_rgba(0,0,0,0.03),0_-2.15px_2.15px_0_rgba(255,255,255,1)_inset,0_2.15px_2.15px_0_rgba(255,255,255,1)_inset]'>
